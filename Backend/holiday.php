...
<tr class="labels styleclass"><th class="styleclass">Sr.No.</th><th class="styleclass">Package Name</th><th class="styleclass">Amount Per Member</th><th class="styleclass">Delete</th></tr>
<?php
$u=1;
...
<td class="styleclass"><?php echo $y['name'];?></td>
<td class="styleclass"><?php echo "INR ".$y['amount'];?></td>
<td class="styleclass"><a href="deleteH.php?del=<?php echo $y['id'];?>" class="link">Delete</a></td>
</tr>
<?php } ?>
</table>
